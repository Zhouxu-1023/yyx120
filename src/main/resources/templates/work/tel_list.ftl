...
<!-- Header Section -->
<section style="background-color: #f2f2f2" id="work-copy-detail" class="section work-detail">

    <table border="1" callpadding="10" width="100%" align="center" bgcolor="cccccc">
        <caption><h4 align="center">盐源县人民医院科室通讯录</h4></caption>
        <tr>
